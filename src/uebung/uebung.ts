...
export function defaultUebungen(): Uebung[] {
    ...
    u1.mittel = 15
    u1.schwer = 20
    u1.beschreibung = "Hände unterhalb der Schulter aufstützen, die Zeigefinger zeigen nach vorne.Füße aufstellen, sodass der Körper von Kopf bis Fuß eine gerade Linie bildet. "+ "\n" + "Einatmend die Ellenbogen beugen und den Körper gerade wie ein Brett Richtung Boden absenken. "+ "\n" + "Ausatmend mit der Kraft des Oberkörpers wieder hochdrücken."
    uebungen.push(u1)
    let u2 = new Uebung();
    u2.id = 2
    u2.name = "Superman"
    ...
    u4.mittel = 10
    u4.schwer = 20
    u4.beschreibung = "Stell dich hüftbreit auf. Jetzt gehst du tief in die Hocke und stützt dich mit den Händen vor den Füßen auf dem Boden ab."+ "\n" + " Die Hände sind schulterbreit auseinander. Spring nun in die Liegestützposition und führe einen Push-up aus. "+ "\n" + "Jetzt springst du mit den Füßen wieder nach vorn, so dass du erneut in Hockposition bist. Zum Abschluss führst du einen kerzengeraden Strecksprung nach oben aus."
    uebungen.push(u4)
    let u5 = new Uebung();
    u5.id = 5
    ...
    u5.mittel = 45
    u5.schwer = 60
    u5.beschreibung = "Um mit Jumping Jacks zu starten, stelle dich aufrecht hin. Die Füße sind schulterschmal. Schaue gerade nach vorne. Deine Arme sind in der Ausgangsposition seitlich neben dem Körper, die Handflächen zeigen nach vorne.  Springe vom Boden ab, indem du zunächst deine Knie minimal beugst und dich vom Boden abstößt. Während du hochspringst, spreizt du deine Beine und führst parallel deine Arme über dem Kopf zusammen. Komme im über hüftbreiten Stand auf dem Boden auf. Deine Hände berühren sich kurz über dem Kopf. Springe sofort wieder ab und komme mit den Füßen in die schulterschmale Ausgangsposition zurück. Führe die Hände zeitgleich hinter dem Oberkörper zusammen."
    uebungen.push(u5)
    let u6 = new Uebung();
    u6.id = 6
    ...
    u6.mittel = 15
    u6.schwer = 20
    u6.beschreibung = "Beginne mit den Händen auf dem Boden in Schulterbreite, Arme gestreckt. Die Hände sollten sich ungefähr in senkrechter Linie mit dem Brustkorb befinden. Halte die Plank-Position im Oberkörper während du deine Knie nacheinander zur projizierten Linie, die sich auf dem Boden befindet, ziehst. "+ "\n" + "Ziehe deine Knie abwechselnd zur projizierten Linie auf dem Boden, während du dich mit den Händen abstützt und deinen Rumpf stabilisierst."
    uebungen.push(u6)
    let u7 = new Uebung();
    u7.id = 7
    u7.name = "Squats"
    ...
    u8.mittel = 15
    u8.schwer = 20
    u8.beschreibung = "Dein Gesäß vor die Bank oder dem Stuhl. Deine Arme sind fast vollständig gestreckt. Beim Einatmen senkst du dein Gesäß in Richtung Boden."+ "\n" + " Die Ellenbogen beugen sich langsam, sodass der Oberarm und Unterarm einen rechten Winkel bilden. Die Ellenbogen bleiben nah am Körper, um den Reiz auf den Trizeps zu legen. Beim Ausatmen drückst du nun deinen Oberkörper wieder nach oben."+ "\n" + " Achte darauf, dass du auch in der Ausgangsposition deine Arme nie vollständig gestreckt hast, um die Ellenbogengelenke zu schützen."
    uebungen.push(u8)
    let u9 = new Uebung();
    u9.id = 9
    u9.name = "Crunces"
    ...
    u13.mittel = 15
    u13.schwer = 20
    u13.beschreibung = "Die Ausgangsposition: Stelle Deine Beine hüftbreit auf. Dein Blick ist nach vorn gerichtet."+ "\n" + " Jetzt machst Du einen großen Schritt nach vorne. Nun senkst du den Körper ab, indem du die Beine in den Knien beugst."+ "\n" + " Achte darauf, dass der vordere Oberschenkel in der Endstellung parallel zum Boden ist. Wichtig ist, dass dein vorderes Knie nicht über die Fußspitze hinausragt, sondern sich über dem Fuß befindet, das hintere Bein berührt den Boden nur fast."+ "\n" + " Jetzt verbleibst Du einen kurzen Moment in dieser Position."+ "\n" + " Um in die Ausgangsposition zurückzukehren, drückst Du Dich aktiv aus dem vorderen Fuß wieder in die Schrittstellung und kehrst dann in die Ausgansposition zurück. Anschließend Beinwechsel. "
    uebungen.push(u13)
    let u14 = new Uebung();
    u14.id = 14
    ...
    u14.mittel = 15
    u14.schwer = 20
    u14.beschreibung = "Auf den Bauch legen, die Arme über den Kopf lang strecken. Lasse die Handflächen auf dem Boden, stelle die Beine nebeneinander. Auch die Fußspitzen sollen auf dem Boden bleiben."+ "\n" + " Nun hebst du deine Brust, deine Arme und Beine an und machst die gleichen Bewegungen wie beim klassischen Schneeengel, d.h. Arme wandern im breiten Bogen zur Hüfte, gleichzeitig öffnest du deine Beine."+ "\n" + " Wieder zur Ausgangsstellung zurückkehren, kurz Arme und Beine ablegen und erneut den umgekehrten Schneeengel ausführen."
    uebungen.push(u14)
    let u15 = new Uebung();
    u15.id = 15
    ...
    u15.mittel = 15
    u15.schwer = 20
    u15.beschreibung = "Starte in der oberen Liegestütz-Position. Senke dann den Körper ab und ziehe das rechte Knie nach vorn. Beim Hochdrücken das Bein wieder nach hinten strecken."+ "\n" + " Beim nächsten Absenken das linke Knie hochziehen usw. Wichtig: Der Rumpf ist während des Satzes komplett angespannt!"
    uebungen.push(u15)
    let u16 = new Uebung();
    u16.id = 16
    u16.name = "Planke"
    ...
    u16.mittel = 40
    u16.schwer = 60
    u16.beschreibung = "Die klassische Ausführung des Unterarmstützes beginnt in liegender Position auf dem Bauch, wobei der Oberkörper auf die Unterarme gestützt ist. Die Ellenbogen befinden sich auf Schulterhöhe."+ "\n" + " Die Unterarme können parallel zueinander liegen oder spitz zulaufen, so dass sich die Hände berühren. "+ "\n" + "Die Füße berühren den Boden nur mit den Zehen. Aus dieser Position versetzt du deinen Körper in Spannung und bringst den durchhängenden Bauch-Hüftbereich in eine Linie mit deinen Schultern und Beinen."
    uebungen.push(u16)
    let u17 = new Uebung();
    u17.id = 17
    ...
    u17.mittel = 15
    u17.schwer = 20
    u17.beschreibung = "Der seitliche Unterarmstütz beginnt damit, dass du mit der linken oder rechten Körperfläche auf dem Boden liegst."+ "\n" + " Es berühren also eine Fußaußenkante, ein Bein, die Hüfte sowie ein Unterarm den Boden."+ "\n" + " Der Unterarm zeigt vom Körper in Blickrichtung weg. Der andere Arm kann in bequemer Position an die Hüfte gelegt werden."+ "\n" + " Aus dieser Position heraus spannst du deinen Körper wieder an und bringst ihn in eine Linie."
    uebungen.push(u17)
    let u18 = new Uebung();
    u18.id = 18
    ...
    u20.mittel = 30
    u20.schwer = 40
    u20.beschreibung = "Deine Füße stehen ungefähr schulterbreit auseinander, aber nicht parallel zueinander. " + "\n" + " Und ab wechseln mit den Fäsuten nach vorne Boxen."
    uebungen.push(u20)
    let u21 = new Uebung();
    u21.id = 21
    ...
    u21.mittel = 15
    u21.schwer = 20
    u21.beschreibung = "Du stehst etwa eine Armlänge von der Wand entfernt. Die Füße stehen mit ganzen Fußsohlen oder auf den Zehenspitzen auf den Boden. Die Hände werden entweder flach oder geballt an der Wand platziert."+ "\n" + " Danach senkst Du den Oberkörper, bis der Kopf fast die Wand berührt."+ "\n" + " Am Umkehrpunkt die Arme langsam bis in die Ausgangsposition drücken"
    uebungen.push(u21)
    let u22 = new Uebung();
    u22.id = 22
    ...
    u22.mittel = 40
    u22.schwer = 60
    u22.beschreibung = "Stelle dich mit dem Rücken an eine Wand. Die Füße sind in etwa hüftbreit, leicht nach außen gedreht aufgestellt."+ "\n" + " Die Arme können seitlich am Körper herabhängen oder vor dem Oberkörper verschränkt werden."+ "\n" + " Rutsche an der Wand mit geradem Rücken herunter bis die Oberschenkel eine waagerechte Position angenommen haben."+ "\n" + " Halte diese Position ohne Körperbewegung so lange wie möglich."
    uebungen.push(u22)
    let u23 = new Uebung();
    u23.id = 23
    ...
    u23.mittel = 15
    u23.schwer = 20
    u23.beschreibung = "Ausgangsposition: Handoberfläche berührt den Boden und dabei berühren sich Daumen und Zeigefinger."+ "\n" + " In der Ausgangsposition sind die Arme durchgestreckt und bilden dabei einen 90° Winkel."+ "\n" + " Die Beine stehen hüftbreit und die Fußspitzen berühren den Boden. Vom Fuß bis zum Kopf weist der Körper eine gerade Linie auf. Ihr senkt den Körper langsam ab und dabei berührt die Brust im Idealfall die Hände. Aller Anfang ist für Einsteiger natürlich schwer. Aber zumindest solltet ihr den Körper so weit absenken, wie es nur geht."
    uebungen.push(u23)
    let u24 = new Uebung();
    u24.id = 24
